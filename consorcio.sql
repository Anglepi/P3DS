...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-06-2018 a las 17:49:25
...
(5, 'Farmacia de verdad', 37.1974, -3.62301);
...
('ANgel', 'angle', '4d186321c1a7f0f354b297e8914ab240', 'Farmaceutico', 'angle@angle.com', 14),
(NULL, NULL, 'hola', 'Farmaceutico', 'a@a.a', 15),
(NULL, NULL, 'password', 'Farmaceutico', 'email', 16);
